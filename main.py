...
bot = telebot.TeleBot('YOUR BOT TOKEN HERE', parse_mode='Markdown', disable_web_page_preview=True) # change "YOUR BOT TOKEN HERE" with your bot token 
stop_events = {}
ongoing_mchk = {}
user_states = {}
gids_file = "gids.txt"
uids_file = 'uids.txt'
owner = [idhere] # your id
admin_ids = [idhere, ] # admins id here
